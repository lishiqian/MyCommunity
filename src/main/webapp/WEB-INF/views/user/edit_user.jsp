...
<div class="container">
    ...
    <div class="row" id="content">
        ...
        <div class="col-md-9" style="min-height: 500px">
            <h4>基本信息
                <a href="/user/edit_user" class="btn btn-info pull-right">保存</a>
                <span class="pull-right">&nbsp;&nbsp;&nbsp;</span>
                <a href="/user/show_user" class="btn btn-info pull-right">取消</a></h4>
            <hr/>
            <div class="container-fluid">
                <div class="row">
                    <img src="../../${login_user.headImg}" class="img-responsive center-block head-img-bg">
                </div>
                <div class="row" style="align-content: center">
                    <p>&nbsp;</p>
                    <center>
                        <span class="button btn-info btn-lg" style="cursor: hand">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"><h3>男</h3></div>
                    </div>
                </div>
            </div>
        </div>
